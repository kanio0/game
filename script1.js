...
var plat = [
    { x: 500, y: 490, width: 150, height: 20, },
    { x: 300, y: 370, width: 100, height: 20, },
    { x: 130, y: 250, width: 75, height: 20, },
    { x: 800, y: 440, width: 150, height: 20, },
    { x: 280, y: 140, width: 50, height: 20, },
    { x: 900, y: 340, width: 50, height: 20, },
    { x: 1100, y: 240, width: 100, height: 20, },
    { x: 600, y: 240, width: 150, height: 20, },
    { x: 840, y: 120, width: 50, height: 20, }];

var gifts = [
    { x: 1135, y: 210, width: 30, height: 30, },
    { x: 850, y: 90, width: 30, height: 30, },
    { x: 290, y: 110, width: 30, height: 30, }]
...
Game.open_d.src = 'img/open_door.png'
//платформы
...
function drawBg() {
    ...
    if (Game.door && Hero.score != 3) {
        canvasContext.drawImage(Game.door, 1150, 475, 70, 120)
    }
    if (Game.open_d && Hero.score == 3) {
        canvasContext.drawImage(Game.open_d, 1150, 485, 90, 120)
    }
}
...
function drawNext() {
    ...
    canvasContext.fillText("Новый уровень!", Game.width / 2, Game.height / 2);
}
...
function drawFrame() {
    ...
    if (showMessage) {
        canvasContext.save();
        canvasContext.font = "40px Marauders Map";
